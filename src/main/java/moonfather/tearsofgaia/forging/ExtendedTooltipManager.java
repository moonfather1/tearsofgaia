...
public class ExtendedTooltipManager
{
	...
	public static void ActivateExtendedTooltip(ItemStack stack, PlayerEntity player, ItemStack otherItem)
	{
	...
	public static boolean ShouldShowExtendedTooltip(ItemStack itemStack, PlayerEntity player)
	{
	...
	private static class PlayerLocationRecordForItems
	{
		...
		public PlayerLocationRecordForItems(PlayerEntity player, double x, double z, ItemStack stack)
		{
			this.player = player;
			this.x = x;
			this.z = z;
